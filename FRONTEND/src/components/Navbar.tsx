...
<div className='flex items-center cursor-pointer gap-2 group'onClick={()=> navigate('/')} >
...
<button onClick={handleMenuToogle} className="flex items-center gap-2 px-3 py-2 rounded-full cursor-pointer hover:bg-purple-50 transition-colors duration-300 border border-transparent  hover:border-purple-200">
<div className="relative" >
{User.avatar ? (
    <img src={User.avatar} alt="avatar" className="h-9 w-9 shadow-sm rounded-full" />
):(
    <div className="w-8 h-8 flex item-center justify-center rounded-full bg-gradient-to-br  from-pink-500 via-purple-500 to-indigo-500 text-white  font-semibold shadow-md " >
...
<li className="p-2" >
<button onClick={handleLogout} className="flex w-full gap-2 rounded-lg text-sm hover:bg-red-50 text-red-600 px-3 py-2 items-center " > 
